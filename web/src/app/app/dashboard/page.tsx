                  ...
                  <Button
                    ...
                    setBridgePath({ source: opportunity.sourceChain, target: opportunity.targetChain });
                      ...
                      setTimeout(() => {
                        ...
                        setPaidLogs((p) => [...p, 'Routing completed']);
                      }, 9000);
                    }}
                  >
                    Visualize routing
          ...
          {bridgeStatus !== 'idle' ? (
            <Card>
              <CardHeader
                ...
                subtitle="Live visualization of cross-chain message passing."
                right={
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (result.intent.type === IntentType.BRIDGE) {
                          ...
                          setTimeout(() => {
                            setBridgeStatus('completed');
                            setPaidLogs((p) => [...p, 'Bridge completed']);
                          }, 9000);
                        }
        ...
        <div className="space-y-4 lg:col-span-12">
          <Card>
            <CardHeader
              ...
              subtitle="Recent on-chain actions executed by your agents."
              right={<History className="h-5 w-5 text-zinc-400" />}
            />
            <CardBody>
