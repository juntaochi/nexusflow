    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-400">Verify → Register → Delegate. Clean and judge-friendly.</p>
        </div>
      ...
      <div className="grid gap-4 lg:grid-cols-12">
        <div className="space-y-4 lg:col-span-5">
          ...
          <Accordion title="What the judge should see" subtitle="Simple demo narration." defaultOpen={true}>
